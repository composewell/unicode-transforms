...
genCompositions :: DType -> PropertiesDB -> String -> String
genCompositions dtype props file = unlines
            [ "{-# OPTIONS_GHC -fno-warn-incomplete-patterns #-}"
            , "-- autogenerated from Unicode data"
            , "module Data.Unicode.Properties." <> file
            , "(composePair)"
...
processFile src outdir = do
    ...
    emitFile "Compositions"    $ genCompositions Canonical   props
    emitFile "CompositionsK"   $ genCompositions Kompat      props
